...
//---------------------------------------------------------------------------------------------
    ...
    let total = data.filter(d=>d.mes == "12").length
    let hours = data.filter(d=>d.mes == "12").map(d=>d.hora)
...
//-------------------------------------------------------------------------------------------
    ...
    let pal_dic = total_palermo.filter(d=>d.mes=="12").length
    let hours_palermo = total_palermo.filter(d=>d.mes=="12").map(d=>d.hora)
